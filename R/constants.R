...
LASTNAMES <- c('Smith', 'Johnson', 'Williams', 'Jones', 'Brown', 'Davis', 'Miller', 
               ...
               'Pittman', 'Brady', 'McCormick', 'Holloway', 'Brock', 'Poole', 
               'Frank', 'Logan', 'Owen', 'Bass', 'Marsh', 'Drake', 'Wong', 
               'Jefferson', 'Park', 'Morton', 'Abbott', 'Sparks', 'Patrick', 
               'Norton', 'Huff', 'Clayton', 'Massey', 'Lloyd', 'Figueroa', 
               'Carson', 'Bowers', 'Roberson', 'Barton', 'Tran', 'Lamb', 
...
STREETS <- list(full= c('Avenue', 'Boulevard', 'Center', 'Circle', 'Court',
                        'Drive', 'Extension', 'Glen', 'Grove', 'Heights', 'Highway',
                        'Junction', 'Key', 'Lane', 'Loop', 'Manor', 'Mill', 'Park',
                        'Parkway', 'Pass', 'Path', 'Pike', 'Place', 'Plaza', 'Point',
                        'Ridge', 'River', 'Road', 'Square', 'Street', 'Terrace',
                        'Trail', 'Turnpike', 'View', 'Way'),
                abbreviation=c('Ave', 'Blvd', 'Ctr', 'Cir', 'Ct', 'Dr', 'Ext', 
                               'Gln', 'Grv', 'Hts', 'Hwy', 'Jct', 'Key', 'Ln',
                               'Loop', 'Mnr', 'Mill', 'Park', 'Pkwy', 'Pass', 
                               'Path', 'Pike', 'Pl', 'Plz', 'Pt', 'Rdg', 'Riv',
                               'Rd', 'Sq', 'St',  'Ter', 'Trl', 'Tpke', 'Vw', 
                               'Way'))
